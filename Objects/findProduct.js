var products=[
    ...
    {code:1010,name:"potatto",mrp:5,aval_qty:50},
]
//search potato
var srch=products.find(item=>item.name=="potatto");
console.log(srch);

//if two times potato then use filter() method
var srch_muliple=products.filter(item=>item.name=="potatto")
console.log("Muliple results of potato",srch_muliple);
